...
document.addEventListener("DOMContentLoaded", function () {
  ...
  captionText.textContent = "Сайт создан ради забавы, не рекомендуется скачивать отсюда файлы, если Вы не НЕДОХАКЕРЫ Lite"
  discriptionText.textContent = "Лучше подпишись на мои YouTube и Telegram каналы"
